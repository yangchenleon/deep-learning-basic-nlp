...
if __name__ == '__main__':
    ...
    torch.save(net.state_dict(), './models/deep_rnn.pth')

    # predict
    model = net
    model.load_state_dict(torch.load('./models/deep_rnn.pth', map_location=devices[0]))
